...
import level1Rules from "../images/image-rules.svg";
import level2Rules from "../images/image-rules-bonus.svg";
import closeRules from "../images/icon-close.svg";
import closeLevel from "../images/icon-close2.svg";
      ...
      <div
        ...
        <div className=" w-full h-full bg-[#f5f5f5] flex flex-col justify-evenly  items-center shadow-xl md:rounded-lg  md:w-[450px] md:h-[450px] md:top-[25%]">
          <div className="relative w-full text-center">
            <span className="text-darkText uppercase text-3xl font-bold ">rules</span>
            <img
              onClick={toggleRule}
          ...
          <img src={level === 2 ? level2Rules : level1Rules} alt="" />
          <img onClick={toggleRule} className=" cursor-pointer md:hidden" src={closeRules} alt="" />
        </div>
      </div>
